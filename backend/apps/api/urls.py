...
urlpatterns = [
    ...
    path("workers/anomalies", views.worker_anomalies, name="worker_anomalies"),
    path("workers/anomalies/summary", views.worker_anomaly_summary, name="worker_anomaly_summary"),
    ...
    path("simulation/scenario", views.simulation_scenario, name="simulation_scenario"),
